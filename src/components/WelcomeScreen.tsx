...
export function WelcomeScreen() {
  ...
  return (
    ...
    >
      ...
      >
        O Void utiliza o escopo restrito do Google Drive para garantir total
        privacidade dos seus dados. No modo local, os dados ficam salvos apenas
        no seu navegador.
      </div>
    </div>
  )
